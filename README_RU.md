...
- **Инструменты** — md5crypt-хеш для `BASIC_AUTH_HASH`; конвертеры AmneziaWG/WireGuard `.conf` (включая **AWG 3.0/3.1**), TrustTunnel `.toml` и OpenVPN `.ovpn` в блок `proxies`; бэкап и восстановление.
